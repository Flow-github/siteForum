...
export class ContactComponent extends AbstractPage{
    ...
    private _subSendMail:Subscription;
    ...
    public ngOnDestroy():void{
        ...
        if(this._subSendMail){
            this._subSendMail.unsubscribe();
        }
    }
    ...
    private formIsValid(){
        this._subSendMail = this._requestService.sendMail(this.contactForm.value).subscribe((res:Response) => this.sendMessageHandler(res), (err:HttpErrorResponse) => this.sendMessageErrorHandler(err));;
